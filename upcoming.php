<?php include "includes/header.php";?> 
      ...
      <div class="main">
        ...
        <div class="font-alt menu-title container" style="position:absolute;color:white;z-index:999999;margin-top:-78px;"><a style="color:white;" href="index.php">Home</a> › <a style="color:white;" href="all.php">Events</a> › Upcoming events
        </div>
          <div class="container">
            <div class="row">
        ...
        <section class="module-small">
          <div class="container">
            ...
            <?php $sql=mysqli_query($con,"SELECT * FROM tblpost WHERE `date`>'$date' ORDER BY post_Id DESC;");
            while($s=mysqli_fetch_assoc($sql))
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                ...
                <?php if(!empty($date)){
                  ...
                  <h4 class="shop-item-title font-alt"><a href="s.php?id=<?php echo $post_Id;?>"><?php echo $title;?></a></h4><span class="fa fa-shopping-cart"></span> <b><?php echo "AUD ".$price;?></b>
                </div>               
              </div>
            <?php } 
