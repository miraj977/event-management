<?php include "includes/header.php";?> 
      ...
      <div class="main">
        <section  style="padding-top:110px;" class="module bg-dark-60 shop-page-header mtop" data-background="assets/bg.png">
        <div class="font-alt menu-title container" style="position:absolute;color:white;z-index:999999;margin-top:-78px;"><a style="color:white;" href="index.php">Home</a> › <a style="color:white;" href="all.php">Events</a> › Past events
        </div>
          <div class="container">
            <div class="row">
